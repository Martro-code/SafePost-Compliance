  ...
  starter: {
    1: {
      ...
      html: (n, u) => wrap(`
        ...
        <p style="color:#475569;">You're on the Starter plan — which gives you 5 free compliance checks so you can see SafePost in action.</p>
    ...
    3: {
      ...
      html: (n, u) => wrap(`
        ...
        <p style="color:#475569;">Hi ${n},</p>
        <p style="color:#475569;">On the Starter plan you have 5 compliance checks to try SafePost out.</p>
        <p style="color:#475569;">When you're ready to do more, here's what upgrading unlocks:</p>
        <p style="color:#475569;">✅ 20–unlimited compliance checks per month<br/>✅ Image and video content analysis<br/>✅ Compliance history<br/>✅ Multi-user access for your team<br/>✅ Priority support</p>
        <p style="color:#475569;"><strong>Your one action today:</strong></p>
    ...
    5: {
      ...
      html: (n, u) => wrap(`
        ...
        <p style="color:#475569;">Hi ${n},</p>
        <p style="color:#475569;">You've had SafePost for a week now. If you haven't used all 5 of your free compliance checks yet, now's a great time.</p>
        <p style="color:#475569;">And if you've already used them and want more — upgrading to Professional gives you 20 checks a month for $20.</p>
        <p style="color:#475569;"><strong>Your one action today:</strong></p>
  ...
  professional: {
    1: {
      ...
      html: (n, u) => wrap(`
        ...
        <p style="color:#475569;">Hi ${n},</p>
        <p style="color:#475569;">Welcome to SafePost! You've just taken the first step toward keeping your practice's online presence AHPRA and TGA compliant.</p>
        <p style="color:#475569;">Your Professional plan gives you 20 compliance checks per month, image and video analysis, and compliance history.</p>
        <p style="color:#475569;"><strong>Your one action today:</strong></p>
    ...
    4: {
      ...
      html: (n, u) => wrap(`
        ...
        <p style="color:#475569;">Hi ${n},</p>
        <p style="color:#475569;">Every compliance check you run is saved in your compliance history — the last 20 checks are stored on your Professional plan.</p>
    ...
    5: {
      ...
      html: (n, u) => wrap(`
        ...
        <p style="color:#475569;">If you're finding you need more than 20 checks per month, or want to add team members to your account, our Pro+ plan gives you 50 checks and up to 3 team members for $49/month.</p>
        <p style="color:#475569;"><strong>Your one action today:</strong></p>
  ...
  pro_plus: {
    1: {
      ...
      html: (n, u) => wrap(`
        <h2 style="color:#1e293b;">Welcome to SafePost!</h2>
        <p style="color:#475569;">Hi ${n},</p>
        <p style="color:#475569;">Welcome to SafePost! You've just unlocked 50 compliance checks per month, multi-user access for up to 3 team members, and full compliance history.</p>
        <p style="color:#475569;"><strong>Your one action today:</strong></p>
    ...
    4: {
      ...
      html: (n, u) => wrap(`
        <h2 style="color:#1e293b;">Your compliance history is building up</h2>
        <p style="color:#475569;">Hi ${n},</p>
        <p style="color:#475569;">Every compliance check you run is saved — your Pro+ plan stores your last 50 checks.</p>
