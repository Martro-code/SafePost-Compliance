  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f7f7f4] dark:bg-gray-900">
      ...
      <main className="flex-grow">
        <div className="max-w-4xl mx-auto px-6 pt-6 pb-10 md:pt-8 md:pb-16">
          {/* Back to Dashboard */}
          <button
          ...
          <div className="bg-white rounded-2xl border border-black/[0.06] shadow-sm p-12 dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center justify-center text-center">
            <div className="w-12 h-12 rounded-xl bg-gray-100 flex items-center justify-center mb-4 dark:bg-gray-700">
