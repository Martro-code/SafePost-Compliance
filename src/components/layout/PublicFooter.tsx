      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><button onClick={() => navigate('/faq')} className="text-[13px] text-gray-500 hover:text-gray-900 transition-colors duration-200">FAQ</button></li>
        ...
        <div className="mt-14 pt-6 border-t border-black/[0.06]">
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/safepostau/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-gray-900 transition-colors duration-200">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/safe-post" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-[#0A66C2] transition-colors duration-200">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/safepost" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-[#1877F2] transition-colors duration-200">
