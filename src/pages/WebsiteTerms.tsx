      ...
      <div className="max-w-6xl mx-auto px-6 pt-10 md:pt-14 pb-16 md:pb-24">
        <div className="grid grid-cols-1 md:grid-cols-[180px_1fr] gap-6 md:gap-12">
          ...
          <div className="max-w-[800px] space-y-8">
            ...
            {/* Access and Use */}
            <div>
              <h2 className="text-lg font-bold text-gray-900 leading-snug mb-3">Access and Use of the Website</h2>
            ...
            {/* Your Obligations */}
            <div>
              <h2 className="text-lg font-bold text-gray-900 leading-snug mb-3">Your Obligations</h2>
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900 leading-snug mb-3">Information on the Website</h2>
              <p className="text-[14px] text-gray-500 leading-relaxed">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900 leading-snug mb-3">Intellectual Property</h2>
              <ul className="list-[lower-alpha] pl-5 space-y-3">
                <li className="text-[14px] text-gray-500 leading-relaxed">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900 leading-snug mb-3">Links to Other Websites</h2>
              <ul className="list-[lower-alpha] pl-5 space-y-3">
                <li className="text-[14px] text-gray-500 leading-relaxed">
            ...
            {/* Reporting Misuse */}
            <div>
              <h2 className="text-lg font-bold text-gray-900 leading-snug mb-3">Reporting Misuse</h2>
              <p className="text-[14px] text-gray-500 leading-relaxed">
            ...
            {/* Privacy */}
            <div>
              <h2 className="text-lg font-bold text-gray-900 leading-snug mb-3">Privacy</h2>
              <p className="text-[14px] text-gray-500 leading-relaxed">
            ...
            {/* Liability */}
            <div>
              <h2 className="text-lg font-bold text-gray-900 leading-snug mb-3">Liability</h2>
              <p className="text-[14px] text-gray-500 leading-relaxed">
            ...
            {/* General */}
            <div>
              <h2 className="text-lg font-bold text-gray-900 leading-snug mb-3">General</h2>
