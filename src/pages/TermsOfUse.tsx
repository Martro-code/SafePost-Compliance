          ...
          <div className="grid grid-cols-1 md:grid-cols-[180px_1fr] gap-6 md:gap-12">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1.5 mb-4">
                ...
                <li className="text-[14px] text-gray-500 leading-relaxed">Registered health practitioners are ultimately and solely responsible for ensuring their advertising and social media content complies with the Health Practitioner Regulation National Law Act 2009, AHPRA advertising guidelines, TGA requirements and any other applicable laws and regulations.</li>
